...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.mainView=[[MainViewController alloc]initWithNibName:@"MainViewController_iphone" bundle:nil];
        }
        else{
        self.mainView=[[MainViewController alloc]initWithNibName:@"MainViewController_iphone4" bundle:nil];
        }
    }
    navi=[[UINavigationController alloc]initWithRootViewController:self.mainView];
